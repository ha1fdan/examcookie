...
namespace Microsoft.Web.WebView2.Core
{
	...
	public class CoreWebView2ContentLoadingEventArgs : EventArgs
	{
		...
		internal ICoreWebView2ContentLoadingEventArgs _nativeICoreWebView2ContentLoadingEventArgs
		{
			get
			{
				if (this._nativeICoreWebView2ContentLoadingEventArgsValue == null)
				{
					try
					{
						this._nativeICoreWebView2ContentLoadingEventArgsValue = (ICoreWebView2ContentLoadingEventArgs)this._rawNative;
					}
				...
				return this._nativeICoreWebView2ContentLoadingEventArgsValue;
			}
			set
			{
				this._nativeICoreWebView2ContentLoadingEventArgsValue = value;
			}
		}
		...
		public Boolean IsErrorPage
		{
			get
			{
				...
				try
				{
					isErrorPage = this._nativeICoreWebView2ContentLoadingEventArgs.IsErrorPage != 0;
				}
		...
		public UInt64 NavigationId
		{
			get
			{
				...
				try
				{
					navigationId = this._nativeICoreWebView2ContentLoadingEventArgs.NavigationId;
				}
				catch (InvalidCastException invalidCastException1)
				{
					InvalidCastException invalidCastException = invalidCastException1;
		...
		{
			this._rawNative = rawCoreWebView2ContentLoadingEventArgs;
		}
	}
}