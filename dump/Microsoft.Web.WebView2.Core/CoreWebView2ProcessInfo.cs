...
namespace Microsoft.Web.WebView2.Core
{
	...
	public class CoreWebView2ProcessInfo
	{
		...
		internal ICoreWebView2ProcessInfo _nativeICoreWebView2ProcessInfo
		{
			get
			{
				if (this._nativeICoreWebView2ProcessInfoValue == null)
				{
					try
					{
						this._nativeICoreWebView2ProcessInfoValue = (ICoreWebView2ProcessInfo)this._rawNative;
					}
				...
				return this._nativeICoreWebView2ProcessInfoValue;
			}
			set
			{
				this._nativeICoreWebView2ProcessInfoValue = value;
			}
		}
		...
		public CoreWebView2ProcessKind Kind
		{
			get
			{
				...
				try
				{
					kind = (CoreWebView2ProcessKind)this._nativeICoreWebView2ProcessInfo.Kind;
				}
		...
		public Int32 ProcessId
		{
			get
			{
				...
				try
				{
					processId = this._nativeICoreWebView2ProcessInfo.ProcessId;
				}
				catch (InvalidCastException invalidCastException1)
				{
					InvalidCastException invalidCastException = invalidCastException1;
		...
		{
			this._rawNative = rawCoreWebView2ProcessInfo;
		}
	}
}