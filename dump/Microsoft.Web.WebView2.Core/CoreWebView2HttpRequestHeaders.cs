...
namespace Microsoft.Web.WebView2.Core
{
	...
	public class CoreWebView2HttpRequestHeaders : IEnumerable<KeyValuePair<String, String>>, IEnumerable
	{
		...
		internal ICoreWebView2HttpRequestHeaders _nativeICoreWebView2HttpRequestHeaders
		{
			...
			set
			{
				this._nativeICoreWebView2HttpRequestHeadersValue = value;
			}
		}
		...
		public Boolean Contains(String name)
		{
			...
			try
			{
				flag = this._nativeICoreWebView2HttpRequestHeaders.Contains(name) != 0;
			}
		...
		public String GetHeader(String name)
		{
			...
			try
			{
				header = this._nativeICoreWebView2HttpRequestHeaders.GetHeader(name);
			}
			catch (InvalidCastException invalidCastException1)
			{
				InvalidCastException invalidCastException = invalidCastException1;
		...
		public CoreWebView2HttpHeadersCollectionIterator GetHeaders(String name)
		{
			...
			try
			{
				coreWebView2HttpHeadersCollectionIterator = new CoreWebView2HttpHeadersCollectionIterator(this._nativeICoreWebView2HttpRequestHeaders.GetHeaders(name));
			}
			catch (InvalidCastException invalidCastException1)
			{
				InvalidCastException invalidCastException = invalidCastException1;
		...
		public CoreWebView2HttpHeadersCollectionIterator GetIterator()
		{
			...
			try
			{
				coreWebView2HttpHeadersCollectionIterator = new CoreWebView2HttpHeadersCollectionIterator(this._nativeICoreWebView2HttpRequestHeaders.GetIterator());
			}
			catch (InvalidCastException invalidCastException1)
			{
				InvalidCastException invalidCastException = invalidCastException1;
